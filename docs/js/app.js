    ...
    $.on('keypress', '.new-todo', e => {
      ...
      if (value && e.keyCode == 13) {
        ...
        _.go(value,
          ...
          _.tap(data => local_db.push(data)),
          _.if(() => localStorage.route !== 'completed') (
            todo_item_template,
            $.append_to('.todo-list')),
          left_item_counter)
      }
